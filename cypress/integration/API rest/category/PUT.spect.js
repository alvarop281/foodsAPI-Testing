...
describe('Test method put for category resource', () => {
    ...
    it('PUT - body has not icon property', () => {
        cy.request({
            method: 'PUT',
            url: 'categories/' + newCategory.id,
            body: {
    ...
    it('PUT - body has id property and has not properties - businessError.length = 3', () => {
        cy.request({
                method: 'PUT',
                url: 'categories/' + newCategory.id,
                body: {
    ...
    it('PUT - body has the property description, with 1 character', () => {
        cy.request({
            method: 'PUT',
            url: 'categories/' + newCategory.id,
            body: {
    ...
    it('PUT - body has the property icon, with 1 character', () => {
        cy.request({
            method: 'PUT',
            url: 'categories/' + newCategory.id,
            body: {
    ...
    it('PUT - update a category with the correct properties - all parameters must match', () => {
        cy.request({
            method: 'PUT',
            url: 'categories/' + newCategory.id,
            headers: {
            ...
            body: {
                description: newDataCategory.description,
                icon: newDataCategory.icon
            }
        }).then((response) => {
            expect(response.body.objects.category).to.have.property('description', newDataCategory.description)
            expect(response.body.objects.category).to.have.property('icon', newDataCategory.icon)
        })
    })
})